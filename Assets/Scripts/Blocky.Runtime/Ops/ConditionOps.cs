namespace Blocky.Runtime.Ops
{
    ...
    {
        public bool Evaluate(ref SlotContext ctx) => BlockyInput.IsMouseDown;
    }
    ...
    {
        public bool Evaluate(ref SlotContext ctx) => true;
    }
    ...
    {
        public bool Evaluate(ref SlotContext ctx) => false;
    }
}
